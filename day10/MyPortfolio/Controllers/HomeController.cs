...
namespace MyPortfolio.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly AppDbContext _context; // DB컨텍
        ...
        public IActionResult Login(User user)
        {
            ...
            var result = _context.User.FromSql<User>($"SELECT * FROM User WHERE UserEmail = {user.UserEmail} AND Password ={ user.Password}").FirstOrDefault();
        ...
        public async Task<IActionResult> Register(User user)
        {
            ...
            {
                // 모든값이 정확히 들어왔음
                user.RegDate = DateTime.Now; // 등록날짜 오늘로 지정
