...
- HTML + CSS + js(jQuery) 응용
    - 웹페이지 클로닝
        ...
        https://github.com/znah54/basic-aspnet-2024/assets/50408406/b88a4de0-b504-45f9-9ad3-df9345acc1d7
...
- ASP.NET 
    - ASP.NET 역사
        ...
        - 웹퍼블리시 - HTML, CSS, Javascript만 가지고 웹피이지만 개발(디자인)
        ...
        - ASP.NET C#이 아닌 다른 .NET 언어로도 개발가능 그중에서 C#을 사용
    ...
    - 브라우저 실행 시 NET::ERR_CRET_INVALID 연결 비공개 설정이 안돼 화면이 안타나는 경우
...
- ASP. NET Core MVC
    - MVC 리뷰
        ...
        - 웹브라우저에서 접근할 페이지를 만들려면
            1. 해당 컨트롤러를 생성
            2. 뷰를 같이 생성할지 나중에 따로 만들지 선택(컨트롤러 메서드이름과 동일한 cshtml 페이자가 생성)
    ...
    - ASP.NET Core 포트폴리오 웹사이트, MyPortfolio
        ...
        3. wwwroot 폴더 밑에 템픞릿 html, css, js, 이미지 등 위치
        4. 템플릿 페이지에 공통적인 부분(Header, Bottom) _layout.cshtml 에 위치
        ...
        9. ResumeController.cs 생성, 뷰를 같이 생성, DB관련된 설정이 없으면 모델, 뷰를 만들기 어려움
        10. Resume 란 폴더가 View아래에 만듦
        11. resume.html에 네비게이션 아래 변경부분만 복사해서 
        ...
        17. model/Board.cs 로 에니티 클래스 생성
        18. appsettings.json에 DB 연결문자열 추가
        19. Data/AppDbContext.cs 생성
        20. Prgram.cs에 DbContext 종속성 주입
        ...
        <img src="https://raw.githubusercontent.com/znah54/basic-aspnet-2024/main/images/an0004.png" width="500">
