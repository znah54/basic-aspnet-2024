...
- 웹기술 개요
    ...
    - Frone-end : 웹사이트 화면으로 사람들에게 보이는 부분 기술 
...
- HTML5
    ...
    - 양식태그 (body > from 안에 사용 필수)
        - frot-end 입력한 내용이 back-end로 보내기위한 관문
        - from을 반드시 사용
        - input
            - type="text" : 텍스트박스
        ...
        - 값 전달 방법
            - GET : URL뒤 ? 다음에 key=value=value... 데이터 전달
...
- HTML5
    - 시맨틱 웹 - 시맨틱 태그로 화면을 구조를 잡는 웹구성 방식
        - header, footer, aside, section, article... 구조태그(화면에 안나타남) 사용
        - 시맨틱 태그를 div로 바꿔도 똑같이 동작하기 때문에 요세는 많이 사용안함, 걷어내고 있는 추세
- CSS3
